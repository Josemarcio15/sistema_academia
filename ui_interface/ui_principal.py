...
"color: white;")
        ...
        self.frame_2.setMinimumSize(QSize(80, 80))
        ...
        self.gridLayout_14.addWidget(self.lineEdit_2, 0, 1, 1, 1)
        ...
        self.gridLayout_12.addLayout(self.gridLayout_14, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Home):
        ...
        self.pushButton_2.setText(QCoreApplication.translate("Home", u"Salvar", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.pagamento_tab), QCoreApplication.translate("Home", u"Efetuar pagamento", None))
        self.pushButton_5.setText(QCoreApplication.translate("Home", u"Buscar", None))
